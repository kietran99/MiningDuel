    ...
    public class DiggableGenerator : NetworkBehaviour, IDiggableGenerator
    {
        ...
        void Update()
        {
            ...
            {               
                ...
                SpawnQuirkObtainAt(5, 5, spawnableQuirkPrefabs.LookUp(prefab => prefab.name.Equals("Drill Machine")).item);
                // SpawnQuirkObtainAt(5, 5, spawnableQuirkPrefabs.LookUp(prefab => prefab.name.Equals("Camo Perse")).item);
            }
        }
    }
}
